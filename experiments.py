...
import sys
import os
os.environ["THEANO_FLAGS"] = "mode=FAST_RUN,device=cuda*,floatX=float32,allow_gc=True,lib.cnmem=0"  # Sets flags for use of GPU
...
def config_variables():
    ...
    # DIRECTORY
    #directory = 'data/stackexchange/allData/allData'
