...
def load_tables():
    ...
    words = []
    utable = numpy.load(os.path.join(path_to_tables, 'utable.npy'), encoding = 'bytes',allow_pickle=True)
    btable = numpy.load(os.path.join(path_to_tables, 'btable.npy'), encoding = 'bytes', allow_pickle=True)
